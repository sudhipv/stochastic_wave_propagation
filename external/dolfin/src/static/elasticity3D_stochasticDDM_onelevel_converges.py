...
class MyExpression(Expression):
    ...
    def eval(self, values, x):
        ...
        meang = 1     #0.1  # similar to meanc in Fortran package
...
#                values[0] = meang*1.0
#            elif self.index == 1:
#                values[0] = meang*(g[0]*cos(omegas[0]*(x[0]))*cos(omegas[0]*(x[1]))*cos(omegasZ[0]*(x[2])))
#            elif self.index == 2:
#                values[0] = meang*(g[1]*cos(omegas[0]*(x[0]))*sin(omegas[1]*(x[1]))*cos(omegasZ[0]*(x[2])))
#            elif self.index == 3:
#                values[0] = meang*(g[0]*cos(omegas[0]*(x[0]))*cos(omegas[0]*(x[1]))*cos(omegasZ[0]*(x[2])))**2/np.sqrt(2)
#            elif self.index == 4:
#                values[0] = meang*((g[0]*cos(omegas[0]*(x[0]))*cos(omegas[0]*(x[1]))*cos(omegasZ[0]*(x[2]))) * \
#                                   (g[1]*cos(omegas[0]*(x[0]))*sin(omegas[1]*(x[1]))*cos(omegasZ[0]*(x[2]))))
#            else:
#               values[0] = meang*(g[1]*cos(omegas[0]*(x[0]))*sin(omegas[1]*(x[1]))*cos(omegasZ[0]*(x[2])))**2/np.sqrt(2)
#        print(E*values[0])
...
def stoVartional(params, u, v, epsilon, f, T):
    ...
    Eg = MyExpression(params, degree=0)
    Es = E*Eg
