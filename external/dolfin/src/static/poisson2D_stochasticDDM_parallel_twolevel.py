...
#ip = MPI.rank(mpi_comm)
#comm_mpi4py = mpi_comm_world().tompi4py()
#ip = comm_mpi4py.Get_rank()
#MPI.Init()
comm = MPI.COMM_WORLD
ip = comm.Get_rank()
#print('My rank is ',ip)
...
class MyExpression(Expression):
    ...
    def eval(self, values, x):
        ...
        meang = 0.04     # similar to meanc in Fortran package
...
#cijkpath = "../data/inputs/cijk"+str(dim_L)+str(order_u)+".mat"
