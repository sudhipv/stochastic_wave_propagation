...
print("==========================================================")
print("Running FEniCS for 3D deterministic elasticity/oneLevel...")
...
rhog = 0.4*delta**2   ## Use 0.04 for beam(1,1,5) and 0.4 for beam(0.2,0.2,1)
...
#nu = 0.35
#E = 70e9
#rhog = 27e3  ## rho*g_forAlluminium = 26.5e3
#mu = 1/(2.0*(1.0+nu))
#lambda_ = (1*nu)/((1+nu)*(1-(2.0*nu)))
