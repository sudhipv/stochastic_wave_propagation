...
def TwoLevelDDMat(A, M, C, b, nNodes, nBnodes, nCnodes):
    ...
    ADic = K_T[0:(nNodes-nBnodes),(nNodes-nCnodes):nNodes]
    ADir = K_T[0:(nNodes-nBnodes),(nNodes-nBnodes):(nNodes-nCnodes)]
    ADcc = K_T[(nNodes-nCnodes):nNodes,(nNodes-nCnodes):nNodes]
    ADrr = K_T[(nNodes-nBnodes):(nNodes-nCnodes),(nNodes-nBnodes):(nNodes-nCnodes)]
    ADrc = K_T[(nNodes-nBnodes):(nNodes-nCnodes),(nNodes-nCnodes):nNodes]
