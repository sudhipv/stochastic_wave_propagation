...
print("========================================================")
print("Convert GMSH mesh to FEniCS mesh")
...
for i in range(nParts):
    ...
    ppath = "../../../data/meshData/points000"+str(i+1)+".dat"
    pts = np.genfromtxt(ppath)
    
    points = np.c_[pts, np.zeros(10)]  ## adding zeros in 3rd column for 2D mesh
    print(ppath)
    # print(points)
    ...
    rpath = "../../../data/meshData/triangles000"+str(i+1)+".dat" ## Global
