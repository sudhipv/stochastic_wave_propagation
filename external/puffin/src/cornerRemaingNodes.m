...
%%--------------------------------------------------------------------------------------------------------
%%- Initiating matrix to assign count (to check in how many nodes exist in each sub-domain.
aa = zeros(1,n);
...
for i = 1:ndom
    ...
    RnodesNum = unique(Rnodes); numberRN = length(RnodesNum);
    numberCRN = [numberCN, numberRN];
    nameRCN  = ['../data/dimcrn00',num2str(i)];
