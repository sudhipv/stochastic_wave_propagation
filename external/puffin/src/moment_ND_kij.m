function  [ijk, cijk]  = moment_ND_kij(ndim, nord, KLEord)
% Main code : By Ajit Desai : July 2015
% Updated   : By Ajit Desai : May 2017
...
%       nord = order of PCE (p) for solution process (PCEout)
%       KLEord = order of expansion for input KLE terms (PCEin)
%
% output:
...
%%: For standard tripple product
%addpath(genpath('/Users/ajit/GIT/SFEMpackage/intrusivePCE/cijk'))

%%: For Non-Diam/normalized tripple product
addpath(genpath('/Users/ajit/GIT/HPCSstoDDM/external/puffin/src/cijk'))
