...
sed -i -e 's/time=0-00:15/time=0-05:00/g' run_fenics3D.sh
...
sed -i -e 's#output=%j-3Dfenics.out#output=/scratch/sudhipv/sudhipv/ssfem_fenics/data/slurm/3Dfenics-%j.out#g' run_fenics3D.sh
