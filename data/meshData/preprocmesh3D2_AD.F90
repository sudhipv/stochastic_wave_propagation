...
integer(kind=8) :: np, ne, nt, nh, nb
integer(kind=8) :: i, j, k, net, temp4, l
...
integer, dimension(:), allocatable :: nti, npi, nei, nhi, nbi
...
allocate(npi(ndom),nti(ndom),nei(ndom),nhi(ndom),nbi(ndom))
