...
dlmwrite('../trianglesShrd.dat', trianglesShrd, '\t')
dlmwrite('../triangles_on_boundary.dat', shrEdg, '\t')
dlmwrite('../trianglesNotShrd.dat', trianglesNotShrd, '\t')
dlmwrite('../num_partition.dat', num_partition, '\t')
dlmwrite('../dbounds.dat', dbounds, '\t')
dlmwrite('../meshdim.dat', meshdim, '\t')
