...
%   Dec/27/2017     AD      Modified to read FEniCS assembled Matric-Vectors & Solve NNC-PCGM
...
GlobalCN = dlmread('../data/corner_nodes.dat', '');          %% Global corner nodes
...
for i = 1:ndom
    ...
    %[p, e, t, h] = getPETH(pn);                      %% Mesh data: P E T
